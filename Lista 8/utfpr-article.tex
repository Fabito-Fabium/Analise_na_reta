...
\begin{enumerate}[wide, labelwidth=!, labelindent=0pt]
	...
	\ExecuteMetaData[Section/sol.tex]{ex10}
	...
	\ExecuteMetaData[Section/sol.tex]{ex11}
\end{enumerate}
\end{document}
